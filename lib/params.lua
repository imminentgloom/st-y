...
function prms:changed(word) -- update interface when param changes
end
...
function prms:init()
   ...
   params:add_group("sound", 10)
      ...
      params:add_control("hz", "hz", controlspec.new(0, 120, "lin", 1, 60))
      ...
      params:add_control("cut", "cut", controlspec.new(20, 20000, "exp", 0, 10000))
